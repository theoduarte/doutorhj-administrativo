...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-6 offset-md-3">
			<div class="card-box">
				<h4 class="header-title m-t-0">Editar Especialidade</h4>
				...
				<form action="{{ route('especialidades.update', $especialidade->id) }}" method="post">
					...
					<div class="form-group">
						...
						<input type="text" id="cd_especialidade" class="form-control" name="cd_especialidade" value="{{ $especialidade->cd_especialidade }}" required placeholder="Código do Especialidade"  >
					</div>
