...
<div class="row">
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('nr_latitude_gps') ? ' has-error' : '' }}">
    		...
    		<input id="nr_latitude_gps" type="text" class="form-control" name="nr_latitude_gps" value="{{$prestador->enderecos->first()->nr_latitude_gps}}" onkeypress="onlyNumbers(event)" required  maxlength="50">
		</div>
	</div>
</div>	
...
<div class="row">
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('te_bairro') ? ' has-error' : '' }}">
    		...
    		<input id="te_bairro" type="text" class="form-control" name="te_bairro" value="{{$prestador->enderecos->first()->te_bairro}}" required  maxlength="250">
		</div>
	</div>
	<div class="col-md-4">
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('nr_longitute_gps') ? ' has-error' : '' }}">
    		...
    		<input id="nr_longitute_gps" type="text" class="form-control" name="nr_longitute_gps" value="{{$prestador->enderecos->first()->nr_longitute_gps}}" onkeypress="onlyNumbers(event)" required  maxlength="50">
		</div>
	</div>
</div>
