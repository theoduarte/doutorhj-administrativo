		...
		<div class="col-md-6">
            ...
            <div class="form-group{{ $errors->has('name_responsavel') ? ' has-error' : '' }}">
            	<div class="row">
                    ...
                    <div class="col-8">
                        <input id="name_responsavel" type="text" class="form-control" name="name_responsavel" value="{{$prestador->responsavel->user->name}}" required  maxlength="50">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('cpf_responsavel') ? ' has-error' : '' }}">
                <div class="row">
                    ...
                    <div class="col-8">
                        <input id="cpf_responsavel" type="text" class="form-control mascaraCPF" name="cpf_responsavel" value="{{$prestador->responsavel->cpf}}" required  maxlength="14">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('telefone_responsavel') ? ' has-error' : '' }}">
                <div class="row">
                    ...
                    <div class="col-8">
                        <input id="telefone_responsavel" type="text" class="form-control" name="telefone_responsavel" value="{{$prestador->responsavel->telefone}}" required  maxlength="20">
                    </div>
                </div>
            </div>
		</div>
