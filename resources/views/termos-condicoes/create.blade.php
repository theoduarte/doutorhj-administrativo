		...
		<div class="col-sm-12">
			<div class="page-title-box">
				...
				<ol class="breadcrumb float-right">
					...
					<li class="breadcrumb-item active">Cadastrar Termos e Condições</li>
				</ol>
	...
	<div class="row">
		<div class="col-md-6 offset-md-3">
			<div class="card-box">
				...
				<form action="{{ route('termos-condicoes.store') }}" method="post" novalidate>
					...
					<div class="form-group">
						<div class="col-md-8">
							...
							<div class="input-daterange-datepicker input-group" id="date-range">
	                            <input type="text" id="dt1" class="form-control" name="dt_inicial" 	value="{{ old('dt_inicial') }}" required placeholder="Início da Vigência" >
	                            <input type="text" id="dt2" class="form-control" name="dt_final" 	value="{{ old('dt_final') }}" required placeholder="Fim da Vigência"  >
	                        </div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<textarea id="ds_termo" class="form-control" name="ds_termo" required>{{ old('ds_termo') }}</textarea>
					</div>
