			...
			<div class="card-box">
				...
				<table class="table table-striped table-bordered table-doutorhj" data-page-size="7">
					...
					<tr>
						...
						<td>
							<a onclick="loadTags(this, {{ $consulta->id }}, '{{$consulta->ds_consulta}}', 'consulta')" class="btn btn-icon waves-effect btn-success btn-sm m-b-5" data-toggle="tooltip" data-placement="left" title="Nomes Populares"><i class="mdi mdi-tag-multiple"></i></a>
