								...
								@foreach($agendamentos as $agendamento)
									@foreach( $agendamento->atendimentos()->whereNull('deleted_at')->get() as $atendimento )
										...
										<tr>
											...
											<td>{{ $agendamento->clinica->nm_razao_social }}</td>
											...
											<td style="width:100px;">
												...
												@if( $agendamento->cs_status == 'Pré-Agendado' 
													...
													$atendimento->consulta->especialidade->ds_especialidade }}"
													   ...
													   tp-prestador="{{ $agendamento->clinica->tp_prestador }}"
													   data-hora="{{ $agendamento->dt_atendimento }}"
													   prestador="{{ $agendamento->clinica->nm_razao_social }}"
													   ...
													   id-clinica="{{ $agendamento->clinica->id }}"
													   nm-clinica="{{ $agendamento->clinica->nm_fantasia }}"
