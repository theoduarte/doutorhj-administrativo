...
<table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
	<tr>
		<td width='30'>&nbsp;</td>
		<td width='250' style='font-family:Arial, Helvetica, sans-serif; font-size: 14px; line-height: 22px; color: #434342; background-color: #fff; text-align: center;'>Consulte no site do laboratório a unidade mais próxima de você</td>
		<td width='40'>&nbsp;</td>
...
<table width='600' border='0' cellspacing='0' cellpadding='0' align='center'>
	<tr>
		<td width='30'>&nbsp;</td>
		<td width='540' style='font-family:Arial, Helvetica, sans-serif; font-size: 14px; line-height: 22px; color: #434342; background-color: #fff; text-align: center;'>Para exames laboratoriais não <br>
			é necessário agendar dia e hora.
		</td>
		<td width='30'>&nbsp;</td>
	</tr>
</table>
