...
// 		$this->middleware("cvx:$action_name");
    ...
    public function index()
    {
    	...
    	$procedimentos = Procedimento::where(DB::raw('to_str(cd_procedimento)'), 'LIKE', '%'.$search_term.'%')->orWhere(DB::raw('to_str(ds_procedimento)'), 'LIKE', '%'.$search_term.'%')->sortable()->paginate(10);
